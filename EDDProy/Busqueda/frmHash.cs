...
namespace EDDemo.Busqueda
{
    public partial class frmHash : Form
    {
        ...
        public frmHash()
        {
            ...
            hashTable = new Hash(); // Inicializa la tabla hash.
        }
        ...
        // Evento que se dispara al hacer clic en el botón de crear lista.
        ...
        // Evento que se dispara al hacer clic en el botón de cargar archivo.
