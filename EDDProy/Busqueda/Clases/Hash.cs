...
namespace EDDemo.Busqueda.Clases
{
    public class Hash
    {
        ...
        // Parámetros:
        // // clave: la clave para la cual se calcula el índice.
        ...
        public void Insertar(string clave, string valor)
        {
            ...
            // Si hay duplicados, crea una subclave para evitar colisiones.
            if (contador > 0)
            {
        ...
        // Parámetros:
        // clave: la clave que se desea buscar.
        ...
        // Parámetros:
        // ruta: la ruta del archivo desde el cual se cargan los datos.
